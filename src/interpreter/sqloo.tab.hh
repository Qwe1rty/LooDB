...
#line 3 "parser/sqloo.y" // lalr1.cc:377
...
#line 64 "sqloo.tab.hh" // lalr1.cc:377
...
namespace yy {
#line 141 "sqloo.tab.hh" // lalr1.cc:377
  ...
  public:
    ...
    union union_type
    {
      ...
      // text
      char dummy3[sizeof(unique_ptr<Entry>)];
};
  ...
  basic_symbol (typename Base::kind_type t, const unique_ptr<Entry> v);
    ...
    , value ()
  {
      switch (other.type_get ())
    {
      ...
      case 33: // text
        value.copy< unique_ptr<Entry> > (other.value);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const unique_ptr<Entry> v)
    : Base (t)
    , value (v)
  {}
  ...
  parser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    switch (yytype)
    {
      ...
      case 33: // text
        value.template destroy< unique_ptr<Entry> > ();
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 33: // text
        value.move< unique_ptr<Entry> > (s.value);
        break;
  ...
  parser::by_type::token () const
  {
    ...
    yytoken_number_[] =
    {
     ...
     265,   266,   267,   268,   269,   270,   271,    59,    44,    40,
      41,    39
    };
  ...
  parser::make_NULL__ ()
  {
    return symbol_type (token::TOK_NULL__);
  }
...
#line 1076 "sqloo.tab.hh" // lalr1.cc:377
